...
function M.load_normal_mode_keymaps()
  ...
  keymap('n', '<CR>', ':w<CR>', { noremap = true, silent = true })
...
function M.load_insert_mode_keymaps()
  ...
  keymap('i', '<CR>', '<Esc>:w<CR>', { noremap = true, silent = true })
  keymap('i', '<Tab>', 'v:lua.tab_complete()', { noremap = true, expr = true, silent = true })
